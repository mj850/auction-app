...
exports.aminoConverters = exports.registry = exports.HttpBody = void 0;
...
exports.HttpBody = {
    ...
    fromJSON(object) {
        return {
            ...
            extensions: globalThis.Array.isArray(object?.extensions) ? object.extensions.map((e) => any_1.Any.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.registry = [["/google.api.HttpBody", exports.HttpBody]];
