...
exports.aminoConverters = exports.registry = exports.TxProof = exports.BlockMeta = exports.LightBlock = exports.SignedHeader = exports.Proposal = exports.ExtendedCommitSig = exports.ExtendedCommit = exports.CommitSig = exports.Commit = exports.Vote = exports.Data = exports.Header = exports.BlockID = exports.Part = exports.PartSetHeader = void 0;
...
const types_2 = require("../../../types/tendermint/types");
...
exports.BlockID = {
    ...
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.part_set_header !== undefined) {
            exports.PartSetHeader.encode(message.part_set_header, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        ...
        message.part_set_header =
            object.part_set_header !== undefined && object.part_set_header !== null ? exports.PartSetHeader.fromPartial(object.part_set_header) : undefined;
        return message;
    }
};
exports.Header = {
    ...
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.last_block_id !== undefined) {
            exports.BlockID.encode(message.last_block_id, writer.uint32(42).fork()).join();
        }
...
exports.Vote = {
    ...
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.block_id !== undefined) {
            exports.BlockID.encode(message.block_id, writer.uint32(34).fork()).join();
        }
...
exports.Commit = {
    ...
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.block_id !== undefined) {
            exports.BlockID.encode(message.block_id, writer.uint32(26).fork()).join();
        }
    ...
    fromJSON(object) {
        return {
            ...
            round: isSet(object.round) ? globalThis.Number(object.round) : 0,
            block_id: isSet(object.block_id) ? exports.BlockID.fromJSON(object.block_id) : undefined,
            signatures: globalThis.Array.isArray(object?.signatures) ? object.signatures.map((e) => exports.CommitSig.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            ...
            extended_signatures: globalThis.Array.isArray(object?.extended_signatures)
                ? object.extended_signatures.map((e) => exports.ExtendedCommitSig.fromJSON(e))
                : []
        };
    },
    toJSON(message) {
...
exports.Proposal = {
    ...
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.block_id !== undefined) {
            exports.BlockID.encode(message.block_id, writer.uint32(42).fork()).join();
        }
        if (message.timestamp !== undefined) {
...
exports.LightBlock = {
    ...
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.signed_header !== undefined) {
            exports.SignedHeader.encode(message.signed_header, writer.uint32(10).fork()).join();
        }
        if (message.validator_set !== undefined) {
            validator_1.ValidatorSet.encode(message.validator_set, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.BlockMeta = {
    ...
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.block_id !== undefined) {
            exports.BlockID.encode(message.block_id, writer.uint32(10).fork()).join();
        }
...
function blockIDFlagFromJSON(object) {
    switch (object) {
        ...
        case "BLOCK_ID_FLAG_UNKNOWN":
            return types_2.BlockIDFlag.BLOCK_ID_FLAG_UNKNOWN;
        case 1:
        case "BLOCK_ID_FLAG_ABSENT":
            return types_2.BlockIDFlag.BLOCK_ID_FLAG_ABSENT;
        case 2:
        case "BLOCK_ID_FLAG_COMMIT":
            return types_2.BlockIDFlag.BLOCK_ID_FLAG_COMMIT;
        case 3:
        case "BLOCK_ID_FLAG_NIL":
            return types_2.BlockIDFlag.BLOCK_ID_FLAG_NIL;
        case -1:
        case "UNRECOGNIZED":
        default:
            return types_2.BlockIDFlag.UNRECOGNIZED;
    }
}
function blockIDFlagToJSON(object) {
    switch (object) {
        case types_2.BlockIDFlag.BLOCK_ID_FLAG_UNKNOWN:
            return "BLOCK_ID_FLAG_UNKNOWN";
        case types_2.BlockIDFlag.BLOCK_ID_FLAG_ABSENT:
            return "BLOCK_ID_FLAG_ABSENT";
        case types_2.BlockIDFlag.BLOCK_ID_FLAG_COMMIT:
            return "BLOCK_ID_FLAG_COMMIT";
        case types_2.BlockIDFlag.BLOCK_ID_FLAG_NIL:
            return "BLOCK_ID_FLAG_NIL";
        case types_2.BlockIDFlag.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
function signedMsgTypeFromJSON(object) {
    switch (object) {
        ...
        case "SIGNED_MSG_TYPE_UNKNOWN":
            return types_2.SignedMsgType.SIGNED_MSG_TYPE_UNKNOWN;
        case 1:
        case "SIGNED_MSG_TYPE_PREVOTE":
            return types_2.SignedMsgType.SIGNED_MSG_TYPE_PREVOTE;
        case 2:
        case "SIGNED_MSG_TYPE_PRECOMMIT":
            return types_2.SignedMsgType.SIGNED_MSG_TYPE_PRECOMMIT;
        case 32:
        case "SIGNED_MSG_TYPE_PROPOSAL":
            return types_2.SignedMsgType.SIGNED_MSG_TYPE_PROPOSAL;
        case -1:
        case "UNRECOGNIZED":
        default:
            return types_2.SignedMsgType.UNRECOGNIZED;
    }
}
function signedMsgTypeToJSON(object) {
    switch (object) {
        case types_2.SignedMsgType.SIGNED_MSG_TYPE_UNKNOWN:
            return "SIGNED_MSG_TYPE_UNKNOWN";
        case types_2.SignedMsgType.SIGNED_MSG_TYPE_PREVOTE:
            return "SIGNED_MSG_TYPE_PREVOTE";
        case types_2.SignedMsgType.SIGNED_MSG_TYPE_PRECOMMIT:
            return "SIGNED_MSG_TYPE_PRECOMMIT";
        case types_2.SignedMsgType.SIGNED_MSG_TYPE_PROPOSAL:
            return "SIGNED_MSG_TYPE_PROPOSAL";
        case types_2.SignedMsgType.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.registry = [
    ["/tendermint.types.PartSetHeader", exports.PartSetHeader],
    ["/tendermint.types.Part", exports.Part],
    ["/tendermint.types.BlockID", exports.BlockID],
    ["/tendermint.types.Header", exports.Header],
    ["/tendermint.types.Data", exports.Data],
    ["/tendermint.types.Vote", exports.Vote],
    ["/tendermint.types.Commit", exports.Commit],
    ["/tendermint.types.CommitSig", exports.CommitSig],
    ["/tendermint.types.ExtendedCommit", exports.ExtendedCommit],
    ["/tendermint.types.ExtendedCommitSig", exports.ExtendedCommitSig],
    ["/tendermint.types.Proposal", exports.Proposal],
    ["/tendermint.types.SignedHeader", exports.SignedHeader],
    ["/tendermint.types.LightBlock", exports.LightBlock],
    ["/tendermint.types.BlockMeta", exports.BlockMeta],
    ["/tendermint.types.TxProof", exports.TxProof]
];
