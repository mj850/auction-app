...
exports.aminoConverters = exports.registry = exports.AllowList = exports.Metadata = exports.DenomUnit = exports.Supply = exports.Output = exports.Input = exports.SendEnabled = exports.Params = void 0;
...
exports.Params = {
    ...
    fromJSON(object) {
        return {
            send_enabled: globalThis.Array.isArray(object?.send_enabled) ? object.send_enabled.map((e) => exports.SendEnabled.fromJSON(e)) : [],
...
exports.Input = {
    ...
    fromJSON(object) {
        return {
            ...
            coins: globalThis.Array.isArray(object?.coins) ? object.coins.map((e) => coin_1.Coin.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.Supply = {
    ...
    fromJSON(object) {
        return { total: globalThis.Array.isArray(object?.total) ? object.total.map((e) => coin_1.Coin.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
...
exports.Metadata = {
    ...
    fromJSON(object) {
        return {
            ...
            denom_units: globalThis.Array.isArray(object?.denom_units) ? object.denom_units.map((e) => exports.DenomUnit.fromJSON(e)) : [],
...
exports.AllowList = {
    ...
    create(base) {
        return exports.AllowList.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseAllowList();
...
exports.registry = [
    ["/cosmos.bank.v1beta1.Params", exports.Params],
    ["/cosmos.bank.v1beta1.SendEnabled", exports.SendEnabled],
    ["/cosmos.bank.v1beta1.Input", exports.Input],
    ["/cosmos.bank.v1beta1.Output", exports.Output],
    ["/cosmos.bank.v1beta1.Supply", exports.Supply],
    ["/cosmos.bank.v1beta1.DenomUnit", exports.DenomUnit],
    ["/cosmos.bank.v1beta1.Metadata", exports.Metadata],
    ["/cosmos.bank.v1beta1.AllowList", exports.AllowList]
];
