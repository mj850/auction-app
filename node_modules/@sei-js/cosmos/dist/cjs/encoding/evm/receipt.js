...
exports.aminoConverters = exports.registry = exports.Receipt = exports.Log = void 0;
...
exports.Receipt = {
    ...
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.logs) {
            exports.Log.encode(v, writer.uint32(106).fork()).join();
        }
    ...
    fromJSON(object) {
        return {
            ...
            logs: globalThis.Array.isArray(object?.logs) ? object.logs.map((e) => exports.Log.fromJSON(e)) : [],
...
exports.registry = [
    ["/seiprotocol.seichain.evm.Log", exports.Log],
    ["/seiprotocol.seichain.evm.Receipt", exports.Receipt]
];
