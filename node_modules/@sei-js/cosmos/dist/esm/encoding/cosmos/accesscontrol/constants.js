...
export function accessOperationSelectorTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "NONE":
...
export function accessOperationSelectorTypeToJSON(object) {
    switch (object) {
...
export function resourceTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "ANY":
...
export function resourceTypeToJSON(object) {
    switch (object) {
...
export function wasmMessageSubtypeFromJSON(object) {
    switch (object) {
        case 0:
        case "QUERY":
...
export function wasmMessageSubtypeToJSON(object) {
    switch (object) {
