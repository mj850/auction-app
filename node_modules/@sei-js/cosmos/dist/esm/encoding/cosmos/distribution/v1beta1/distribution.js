...
export const ValidatorAccumulatedCommission = {
    ...
    fromJSON(object) {
        return {
            commission: globalThis.Array.isArray(object?.commission) ? object.commission.map((e) => DecCoin.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
...
export const FeePool = {
    ...
    fromJSON(object) {
        return {
            community_pool: globalThis.Array.isArray(object?.community_pool) ? object.community_pool.map((e) => DecCoin.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
