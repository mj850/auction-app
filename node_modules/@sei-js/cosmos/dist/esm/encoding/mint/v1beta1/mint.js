    ...
    fromJSON(object) {
        return {
            ...
            token_release_schedule: globalThis.Array.isArray(object?.token_release_schedule)
                ? object.token_release_schedule.map((e) => ScheduledTokenRelease.fromJSON(e))
                : []
        };
    },
    toJSON(message) {
...
export const Version2Params = {
    ...
    fromJSON(object) {
        return {
            mint_denom: isSet(object.mint_denom) ? globalThis.String(object.mint_denom) : "",
            token_release_schedule: globalThis.Array.isArray(object?.token_release_schedule)
                ? object.token_release_schedule.map((e) => Version2ScheduledTokenRelease.fromJSON(e))
                : []
        };
    },
    toJSON(message) {
...
export const registry = [
    ["/seiprotocol.seichain.mint.Minter", Minter],
    ["/seiprotocol.seichain.mint.ScheduledTokenRelease", ScheduledTokenRelease],
    ["/seiprotocol.seichain.mint.Params", Params],
