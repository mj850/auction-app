...
export declare const Encoder: {
    confidentialtransfers: typeof confidentialtransfers;
    confio: typeof confio;
    cosmos: {
        accesscontrol: typeof cosmos_accesscontrol;
        accesscontrol_x: typeof cosmos_accesscontrol_x;
        auth: {
            v1beta1: typeof cosmos_auth_v1beta1;
        };
        authz: {
            v1beta1: typeof cosmos_authz_v1beta1;
        };
        bank: {
            v1beta1: typeof cosmos_bank_v1beta1;
        };
        base: {
            abci: {
                v1beta1: typeof cosmos_base_abci_v1beta1;
            };
            kv: {
                v1beta1: typeof cosmos_base_kv_v1beta1;
            };
            query: {
                v1beta1: typeof cosmos_base_query_v1beta1;
            };
            reflection: {
                v1beta1: typeof cosmos_base_reflection_v1beta1;
                v2alpha1: typeof cosmos_base_reflection_v2alpha1;
            };
            snapshots: {
                v1beta1: typeof cosmos_base_snapshots_v1beta1;
            };
            store: {
                v1beta1: typeof cosmos_base_store_v1beta1;
            };
            tendermint: {
                v1beta1: typeof cosmos_base_tendermint_v1beta1;
            };
            v1beta1: typeof cosmos_base_v1beta1;
        };
        capability: {
            v1beta1: typeof cosmos_capability_v1beta1;
        };
        crisis: {
            v1beta1: typeof cosmos_crisis_v1beta1;
        };
        crypto: {
            ed25519: typeof cosmos_crypto_ed25519;
            multisig: typeof cosmos_crypto_multisig;
            secp256k1: typeof cosmos_crypto_secp256k1;
            secp256r1: typeof cosmos_crypto_secp256r1;
            sr25519: typeof cosmos_crypto_sr25519;
        };
        distribution: {
            v1beta1: typeof cosmos_distribution_v1beta1;
        };
        evidence: {
            v1beta1: typeof cosmos_evidence_v1beta1;
        };
        feegrant: {
            v1beta1: typeof cosmos_feegrant_v1beta1;
        };
        genutil: {
            v1beta1: typeof cosmos_genutil_v1beta1;
        };
        gov: {
            v1beta1: typeof cosmos_gov_v1beta1;
        };
        mint: {
            v1beta1: typeof cosmos_mint_v1beta1;
        };
        params: {
            types: typeof cosmos_params_types;
            v1beta1: typeof cosmos_params_v1beta1;
        };
        slashing: {
            v1beta1: typeof cosmos_slashing_v1beta1;
        };
        staking: {
            v1beta1: typeof cosmos_staking_v1beta1;
        };
        tx: {
            signing: {
                v1beta1: typeof cosmos_tx_signing_v1beta1;
            };
            v1beta1: typeof cosmos_tx_v1beta1;
        };
        upgrade: {
            v1beta1: typeof cosmos_upgrade_v1beta1;
        };
        vesting: {
            v1beta1: typeof cosmos_vesting_v1beta1;
        };
    };
    epoch: typeof epoch;
    eth: typeof eth;
    evm: typeof evm;
    google: {
        api: typeof google_api;
        protobuf: typeof google_protobuf;
    };
    mint: {
        v1beta1: typeof mint_v1beta1;
    };
    oracle: typeof oracle;
    tendermint: {
        abci: typeof tendermint_abci;
        crypto: typeof tendermint_crypto;
        libs: {
            bits: typeof tendermint_libs_bits;
        };
        p2p: typeof tendermint_p2p;
        types: typeof tendermint_types;
        version: typeof tendermint_version;
    };
