...
import { bytesToHex, hexToBytes, keccak256, parseEther, toBytes, isAddress } from "viem";
 ...
 */
export async function queryAccountViem(client, address, denom) {
    // Sanity checks
 ...
 */
export async function decryptPendingBalancesViem(signedDenom, ctAccount) {
    // Sanity checks
 ...
 */
export async function decryptDecryptableAvailableBalanceViem(signedDenom, ctAccount) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
 ...
 * @returns The decrypted available balance.
 */
export async function decryptAvailableBalanceViem(signedDenom, ctAccount) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
 ...
 */
export async function decryptAccountViem(signedDenom, ctAccount, decryptFullAvailableBalance) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
 ...
 */
export async function getInitializeAccountViemArgs(signedDenom, address, denom) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
 ...
 * @returns A Viem-compatible calldata params object.
 */
export function getDepositToPrivateBalanceViemArgs(address, denom, amount) {
    // Sanity checks
 ...
 */
export async function getApplyPendingBalancesViemArgs(address, denom, client, signedDenom) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
    ...
    const applyPendingBalancesPayload = api.createApplyPendingBalance(signedDenomArray, address, denom, ctAccount.pendingBalanceCreditCounter, ctAccount.decryptableAvailableBalance, hexToBytes(ctAccount.availableBalance), hexToBytes(ctAccount.pendingBalanceLo), hexToBytes(ctAccount.pendingBalanceHi));
 ...
 * @returns A Viem-compatible calldata params object or null if the account is uninitialized.
 */
export async function getWithdrawFromPrivateBalanceViemArgs(address, denom, amount, client, signedDenom) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
    ...
    const withdrawPayload = api.createWithdraw(signedDenomArray, amount, address, denom, ctAccount.decryptableAvailableBalance, hexToBytes(ctAccount.availableBalance));
 ...
 */
export async function getConfidentialTransferViemArgs(senderAddress, recipientAddress, denom, amount, client, signedDenom) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
    ...
    const transferPayload = api.createTransfer(signedDenomArray, amount, senderAddress, recipientAddress, denom, senderAccount.decryptableAvailableBalance, hexToBytes(senderAccount.availableBalance), hexToBytes(recipientAccount.publicKey));
 ...
 */
export function getDenomToSignViem(denom) {
