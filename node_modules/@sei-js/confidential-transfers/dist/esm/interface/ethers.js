import { getBytes, isAddress, keccak256, toUtf8Bytes } from "ethers";
 ...
 */
export async function queryAccountEthers(address, denom, contractRunner) {
    // Sanity checks
 ...
 */
export async function decryptPendingBalancesEthers(signedDenom, ctAccount) {
    // Sanity checks
 ...
 */
export async function decryptDecryptableAvailableBalanceEthers(signedDenom, ctAccount) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
 ...
 */
export async function decryptAvailableBalanceEthers(signedDenom, ctAccount) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
 ...
 */
export async function decryptAccountEthers(signedDenom, ctAccount, decryptFullAvailableBalance) {
    // Sanity checks
    if (!/^0x[0-9a-fA-F]+$/.test(signedDenom) || signedDenom.length !== 132) {
        throw new Error('Invalid signedDenom format');
    }
 ...
 */
export async function initializeAccountEthers(signedDenom, address, denom, contractRunner) {
    // Sanity checks
    if (!isAddress(address)) {
        throw new Error('Invalid address format');
    }
 ...
 */
export async function depositToPrivateBalanceEthers(denom, amount, contractRunner) {
    // Sanity checks
    if (denom.trim() === '') {
        throw new Error('Denom cannot be empty');
    }
 ...
 */
export async function applyPendingBalanceEthers(address, denom, signedDenom, contractRunner) {
    // Sanity checks
    if (!isAddress(address)) {
        throw new Error('Invalid address format');
    }
 ...
 */
export async function withdrawFromPrivateBalanceEthers(address, denom, amount, signedDenom, contractRunner) {
    // Sanity checks
    if (!isAddress(address)) {
        throw new Error('Invalid address format');
    }
 ...
 */
export async function confidentialTransferEthers(senderAddress, recipientAddress, denom, amount, signedDenom, contractRunner) {
    // Sanity checks
 ...
 */
export async function closeAccountEthers(address, denom, signedDenom, contractRunner) {
    // Sanity checks
    if (!isAddress(address)) {
        throw new Error('Invalid address format');
    }
 ...
 */
export function getDenomToSignEthers(denom) {
    if (denom.trim() === '') {
        throw new Error('Denom cannot be empty');
    }
