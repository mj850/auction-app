...
exports.ConfidentialTransfers = void 0;
const encoding_1 = require("@sei-js/cosmos/encoding");
const utils_1 = require("../utils/utils");
const embeddedWasm_1 = require("./embeddedWasm");
const global = globalThis;
class ConfidentialTransfers {
    ...
    async initialize() {
        ...
        const wasmBytes = (0, utils_1.base64ToBytes)(embeddedWasm_1.ctWasmBase64.trim());
    ...
    createWithdraw(signedDenom, amount, address, denom, currentDecryptableBalance, currentAvailableBalance) {
        ...
        const result = encoding_1.Encoder.confidentialtransfers.MsgWithdraw.fromJSON(withdrawStructJson);
        return result;
    }
    createInitialize(signedDenom, address, denom) {
        ...
        const signedDenomBase64 = (0, utils_1.base64FromBytes)(signedDenom);
        ...
        const result = encoding_1.Encoder.confidentialtransfers.MsgInitializeAccount.fromJSON(initializeStructJson);
    ...
    createApplyPendingBalance(signedDenom, address, denom, pendingBalanceCreditCounter, currentDecryptableBalance, currentAvailableBalance, currentPendingBalanceLo, currentPendingBalanceHi) {
        ...
        const signedDenomBase64 = (0, utils_1.base64FromBytes)(signedDenom);
        const availableBalanceBase64 = (0, utils_1.base64FromBytes)(currentAvailableBalance);
        const pendingBalanceLoBase64 = (0, utils_1.base64FromBytes)(currentPendingBalanceLo);
        const pendingBalanceHiBase64 = (0, utils_1.base64FromBytes)(currentPendingBalanceHi);
        ...
        const result = encoding_1.Encoder.confidentialtransfers.MsgApplyPendingBalance.fromJSON(applyPendingBalanceStructJson);
        return result;
    }
    createTransfer(signedDenom, amount, senderAddress, recipientAddress, denom, currentDecryptableBalance, currentAvailableBalance, recipientPubkey) {
        ...
        const signedDenomBase64 = (0, utils_1.base64FromBytes)(signedDenom);
        const availableBalanceBase64 = (0, utils_1.base64FromBytes)(currentAvailableBalance);
        const recipientPubkeyBase64 = (0, utils_1.base64FromBytes)(recipientPubkey);
        ...
        const result = encoding_1.Encoder.confidentialtransfers.MsgTransfer.fromJSON(transferStructJson);
        return result;
    }
    createCloseAccount(signedDenom, address, denom, currentAvailableBalance, currentPendingBalanceLo, currentPendingBalanceHi) {
        ...
        const result = encoding_1.Encoder.confidentialtransfers.MsgCloseAccount.fromJSON(closeAccountStructJson);
        return result;
    }
    decryptCiphertext(signedDenom, ciphertext) {
        ...
        const signedDenomBase64 = (0, utils_1.base64FromBytes)(signedDenom);
        const ciphertextBase64 = (0, utils_1.base64FromBytes)(ciphertext);
...
exports.ConfidentialTransfers = ConfidentialTransfers;
